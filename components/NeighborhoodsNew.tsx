        ...
        <section id="neighborhoods" className="py-24 relative overflow-hidden bg-white">
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-[#0B143E] rounded-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden">
                    ...
                    <div className="absolute top-0 right-1/4 w-[400px] h-[400px] bg-gradient-to-bl from-brand-cyan/20 to-transparent rounded-full blur-3xl" />
                    <div className="absolute bottom-0 left-1/4 w-[400px] h-[400px] bg-gradient-to-tr from-brand-orange/20 to-transparent rounded-full blur-3xl" />
