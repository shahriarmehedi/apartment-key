...
export const CTA: React.FC = () => {
    return (
        <section id="cta" className="pt-14 relative overflow-hidden bg-white">
            {/* Dark background container with full width and rounded bottom */}
            <div className="bg-[#0B143E] rounded-b-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden">
                {/* Animated Orbs inside dark container */}
                <motion.div
                    animate={{
                        scale: [1, 1.2, 1],
                        opacity: [0.4, 0.6, 0.4],
                ...
                <div className="relative z-10 max-w-4xl mx-auto text-center">
                    ...
                    <motion.div
                        ...
                        className="text-lg sm:text-xl text-gray-300 mb-12 max-w-2xl mx-auto space-y-3"
                    >
                        <TextAnimate
                            animation="slideUp"
                            by="word"
