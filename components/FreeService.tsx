...
export const FreeService: React.FC = () => {
    return (
        <section id="free-service" className="py-24 relative overflow-hidden bg-white">
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-[#0B143E] rounded-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden">
                    {/* Decorative gradient orbs inside dark container */}
                    <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-gradient-to-r from-brand-orange/20 to-transparent rounded-full blur-3xl transform -translate-y-1/2" />
                    <div className="absolute bottom-1/4 right-0 w-[400px] h-[400px] bg-gradient-to-l from-brand-cyan/20 to-transparent rounded-full blur-3xl" />
                        ...
                        >
                            ...
                            >
                                <p className="text-base sm:text-lg leading-relaxed">
                                    <span className="font-semibold text-gray-100">Why pay for apartment hunting when you can get expert help for <span className='text-brand-orange'>FREE?</span></span>
                                </p>
                                <p className="text-base sm:text-lg leading-relaxed">
